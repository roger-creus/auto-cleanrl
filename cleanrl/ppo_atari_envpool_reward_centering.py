...
# Modification: Reward Centering (Sutton et al. 2024, arxiv 2405.09999)
# Subtracts a running estimate of the mean reward during GAE computation
# so the value function learns deviations from the average.
import csv
import os
import random
import time
...
class Args:
    ...
    # Reward centering (Sutton et al. 2024)
    reward_centering_beta: float = 0.999
    """smoothing coefficient for reward centering EMA"""
...
if __name__ == "__main__":
    ...
    # Reward centering: running mean reward estimate (Sutton et al. 2024)
    r_bar = 0.0
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        # Update reward centering EMA (once per rollout)
        r_bar = args.reward_centering_beta * r_bar + (1 - args.reward_centering_beta) * rewards.mean().item()
        ...
        with torch.no_grad():
            ...
            for t in reversed(range(args.num_steps)):
                ...
                delta = (rewards[t] - r_bar) + args.gamma * nextvalues * nextnonterminal - values[t]
                advantages[t] = lastgaelam = delta + args.gamma * args.gae_lambda * nextnonterminal * lastgaelam
            returns = advantages + values

        # Log reward centering stats
        writer.add_scalar("reward_centering/r_bar", r_bar, global_step)
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "ppo_reward_centering",
