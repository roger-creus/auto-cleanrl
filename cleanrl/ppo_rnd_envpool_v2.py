...
if __name__ == "__main__":
    ...
    if not args.experiment_id:
        args.experiment_id = f"{args.env_id.replace('-v5', '').lower()}-s{args.seed}"
    ...
    for update in range(1, num_updates + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            if step_returns:
                ...
                print(
                    f"global_step={global_step}, episodic_return={mean_ret:.1f} (n={len(step_returns)})"
                    f", curiosity_reward={np.mean(curiosity_rewards[step].cpu().numpy()):.4f}"
                )
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "ppo_rnd",
