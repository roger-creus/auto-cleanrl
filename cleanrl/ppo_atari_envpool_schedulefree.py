# PPO + Schedule-Free AdamW optimizer (h018)
# Based on ppo_atari_envpool.py with schedulefree.AdamWScheduleFree replacing Adam
...
class Args:
    ...
    """Toggle learning rate annealing (disabled by default for schedule-free)"""
    gamma: float = 0.99
    ...
    """number of warmup steps for schedule-free optimizer"""

    # results tracking
    hypothesis_id: str = "h018"
...
if __name__ == "__main__":
    ...
    optimizer = schedulefree.AdamWScheduleFree(
        agent.parameters(), lr=args.learning_rate, warmup_steps=args.warmup_steps
    )
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        # Schedule-Free: switch to averaged parameters for inference
        optimizer.eval()
        ...
        # Schedule-Free: switch to online parameters for training
        optimizer.train()
    ...
    # Switch to eval mode for final metrics (use averaged params)
    optimizer.eval()
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "ppo_schedulefree",
