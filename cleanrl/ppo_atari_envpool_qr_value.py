# PPO with Quantile Regression Value Function
# Novel approach: replace scalar V(s) with N quantile predictions of the return distribution
# The mean of quantile predictions serves as V(s) for advantage estimation
# Training uses quantile Huber loss for richer gradient signal and robust value estimates
# This captures the full distribution of returns, not just the mean
import csv
import os
import random
import time
...
if __name__ == "__main__":
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "ppo_qr_value",
