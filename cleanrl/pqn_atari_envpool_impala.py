# PQN with IMPALA-style ResNet encoder for Atari (envpool)
# Based on pqn_atari_envpool.py but replaces NatureCNN with IMPALA CNN
import csv
import os
import random
import time
...
# IMPALA-style ResNet building blocks
...
class QNetwork(nn.Module):
    def __init__(self, env):
        ...
        flat_size = shape[0] * shape[1] * shape[2]
        self.head = nn.Sequential(
            ...
            nn.LayerNorm(256),
            nn.ReLU(),
            layer_init(nn.Linear(256, env.single_action_space.n)),
        )
...
if __name__ == "__main__":
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "pqn_impala",
