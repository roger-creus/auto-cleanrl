# DQN for Atari using envpool — off-policy baseline with vectorized environments
# Adapted from cleanrl/dqn_atari.py to use envpool for fast parallel data collection
import csv
import os
import random
import time
...
if __name__ == "__main__":
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "dqn",
