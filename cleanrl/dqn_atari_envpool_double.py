# Double DQN for Atari using envpool — reduces overestimation bias
# Key change: use online network to SELECT action, target network to EVALUATE value
...
if __name__ == "__main__":
        ...
        if global_step > args.learning_starts:
            if (global_step // args.num_envs) % args.train_frequency == 0:
                ...
                with torch.no_grad():
                    ...
                    next_actions = q_network(s_next_obs).argmax(dim=1, keepdim=True)
                    target_q_values = target_network(s_next_obs).gather(1, next_actions).squeeze(1)
                    td_target = s_rewards + args.gamma * target_q_values * (1 - s_dones)
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "double_dqn",
