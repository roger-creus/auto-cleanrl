...
# Variant: entropy coefficient annealing (high exploration early, low exploitation late)
import csv
import os
import random
import time
...
class Args:
    ...
    ent_coef: float = 0.03
    """coefficient of the entropy (overwritten by annealing schedule)"""
    ent_coef_start: float = 0.03
    """initial entropy coefficient (high exploration)"""
    ent_coef_end: float = 0.001
    """final entropy coefficient (low exploitation)"""
    vf_coef: float = 0.5
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        ent_coef_now = args.ent_coef_end + ent_frac * (args.ent_coef_start - args.ent_coef_end)
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "ppo_entanneal",
