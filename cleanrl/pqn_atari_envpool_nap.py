...
class NaP:
    ...
    def __init__(self, model):
        ...
        for name, param in model.named_parameters():
            if param.dim() >= 2:  # Only project weight matrices, not biases
...
if __name__ == "__main__":
    ...
    nap = NaP(q_network)  # Initialize NaP with initial weight norms
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                optimizer.step()
                nap.project(q_network)  # Project weights back to initial norms
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "pqn_nap",
