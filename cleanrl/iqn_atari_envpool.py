# IQN (Implicit Quantile Networks) for Atari using envpool
# Dabney et al., 2018 — "Implicit Quantile Networks for Distributional RL"
# Instead of fixed quantile fractions (QR-DQN), IQN samples random τ from U(0,1)
# and uses cosine embeddings to implicitly represent any quantile function.
# This allows risk-sensitive policies and more flexible return distributions.
# Based on qrdqn_atari_envpool.py for envpool setup, replay buffer, and CSV saving.
import csv
import os
import random
import time
...
if __name__ == "__main__":
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "iqn",
