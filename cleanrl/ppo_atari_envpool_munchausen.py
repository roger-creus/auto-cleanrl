...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        with torch.no_grad():
            ...
            for t in reversed(range(args.num_steps)):
                ...
                munch_bonus = args.munchausen_alpha * args.munchausen_tau * torch.clamp(logprobs[t], min=args.munchausen_clip, max=0.0)
                delta = (rewards[t] + munch_bonus) + args.gamma * nextvalues * nextnonterminal - values[t]
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "ppo_munchausen",
