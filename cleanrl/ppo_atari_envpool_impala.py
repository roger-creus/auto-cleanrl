# PPO with IMPALA-style ResNet encoder for Atari via EnvPool
# Based on ppo_atari_envpool.py but replaces NatureCNN with IMPALA CNN
import csv
import os
import random
import time
...
class Agent(nn.Module):
    def __init__(self, envs):
        ...
        # Input 84x84 -> after 3 maxpool(3,2,1): 84->42->21->11
...
if __name__ == "__main__":
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "ppo_impala",
