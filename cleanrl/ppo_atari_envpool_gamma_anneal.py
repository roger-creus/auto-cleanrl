...
class Args:
    ...
    gamma_start: float = 0.95
    """initial discount factor (annealed toward gamma_end over training)"""
    gamma_end: float = 0.999
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        # Anneal discount factor
        current_gamma = args.gamma_start + (args.gamma_end - args.gamma_start) * ((iteration - 1) / max(args.num_iterations - 1, 1))
        ...
        with torch.no_grad():
            ...
            for t in reversed(range(args.num_steps)):
                ...
                delta = rewards[t] + current_gamma * nextvalues * nextnonterminal - values[t]
                advantages[t] = lastgaelam = delta + current_gamma * args.gae_lambda * nextnonterminal * lastgaelam
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "ppo_gamma_anneal",
