...
class Args:
    ...
    tv_coef: float = 0.01
    """coefficient for TV divergence penalty"""
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                # SPO Policy loss: replace hard clipping with soft TV divergence penalty.
                # TV divergence lower bound for the taken action: 0.5 * |pi(a|s) - pi_old(a|s)|
                # = 0.5 * pi_old(a|s) * |ratio - 1|, which is proportional to |ratio - 1|.
                # Full objective: maximize (advantage * ratio) - tv_coef * |ratio - 1|
                pg_loss = (-mb_advantages * ratio + args.tv_coef * (ratio - 1).abs()).mean()
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "ppo_spo",
