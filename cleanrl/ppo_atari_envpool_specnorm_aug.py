# PPO + Spectral Normalization + DrQ-style Data Augmentation
# Combination of h013 (specnorm) and h012 (DrQ aug) — both showed complementary wins
# SpectralNorm: stabilizes CNN representations, prevents rank collapse
# DrQ aug: random shift improves representation quality, especially for PrivateEye
import csv
import os
import random
import time
...
class Agent(nn.Module):
    def __init__(self, envs):
        super().__init__()
        # SpectralNorm on Conv2d layers for stable representations
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                # DrQ-style augmentation: apply random shift during training only
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "ppo_specnorm_aug",
