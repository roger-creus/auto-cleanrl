# IQN + Higher Replay Ratio + Periodic Soft Resets for Atari using envpool
# Inspired by BBF (Bigger, Better, Faster — Schwarzer et al. 2023):
#   - Replay ratio increased from ~0.5 to 2.0 (4x more gradient updates per env step)
#   - Periodic soft resets of the value head every reset_interval steps to prevent
#     loss of plasticity from the additional gradient updates
# The hypothesis: IQN already learns a rich distributional representation; increasing
# replay ratio lets it extract more learning signal per environment transition.
# Soft resets (shrink weights toward 0 by reset_fraction) maintain plasticity.
import csv
import os
import random
import time
...
if __name__ == "__main__":
    ...
    while global_step < args.total_timesteps:
        ...
        with torch.no_grad():
            # Sample K quantiles for action selection
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "iqn_replay",
