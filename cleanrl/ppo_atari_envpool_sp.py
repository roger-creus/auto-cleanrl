...
# Variant: Soft Shrink-and-Perturb (SP) regularization for plasticity maintenance.
# After each optimizer.step(), weight matrices are shrunk toward zero and perturbed
...
if __name__ == "__main__":
    ...
    if all_episode_returns:
        ...
        with open(csv_path, "w", newline="") as f:
            ...
            w.writerow([args.env_id, args.seed, args.hypothesis_id, args.experiment_id, "ppo_sp",
