...
## Session 206: Bank h066-battlezone-s3 — 32 Phase 3 jobs running

### Triggered by: h066-battlezone-s3 (job 10755004, nibi SUCCESS)

### RESULT BANKED: 1
h066-battlezone-s3: IQN+OQE BattleZone seed 3, q4=3506.11 (vs s1=3726.05, s2=3681.27). All 3 seeds complete. 3-seed avg q4=3637.81. PPO avg=2163.71 WIN (+68.1%). IQN avg=3306.86. OQE slightly better than IQN (+10%).

### PHASE 3 COVERAGE:
- h001 PPO: 45/45 COMPLETE
- h063 IQN: 37/45 banked (8/15 games 3-seed complete) + 8 running
- h064 Rainbow-lite: 35/45 banked (6/15 games 3-seed complete) + 10 running
- h066 IQN+OQE: 31/45 banked (3/15 games 3-seed complete) + 14 running
All 32 missing experiments covered by running jobs. No gaps.
...
Rainbow-lite dominant. OQE adds negligible benefit over vanilla IQN (+0.0003 IQM).

### 32 RUNNING JOBS:
Seed-2 remaining (5): h063-qbert-s2 (fir), h064-breakout-s2 (narval), h064-solaris-s2 (fir), h066-alien-s2 (narval), h066-solaris-s2 (narval)
Seed-3 (27): spread across narval/nibi/fir, 8-10h walltime
...
---
**[2026-03-23 01:54 UTC]**

## Session 207: Bank h066-alien-s3 — 31 Phase 3 jobs running

### Triggered by: h066-alien-s3 (job 10754986, nibi SUCCESS)

### RESULT BANKED: 1
h066-alien-s3: IQN+OQE Alien seed 3, q4=305.57 (vs s1=310.64). PPO s3=196.30 WIN (+55.7%). vs IQN s3=307.93 TIE (-0.8%). OQE neutral on Alien.

### BUG FIX: IQM computation now includes Enduro/Venture
Previous sessions missed Enduro and Venture because PPO q4=0.0 was treated as falsy in Python. Fixed to use 'is not None' check. Impact: h064 Rainbow-lite gets credit for Enduro WIN (+0.0254 HNS), boosting its lead. IQN/OQE get near-TIE on both Enduro and Venture.

### PHASE 3 COVERAGE (all 15 games included):
- h001 PPO: 45/45 COMPLETE
- h063 IQN: 37/45 banked (8/15 games 3-seed complete) + 8 running
- h064 Rainbow-lite: 35/45 banked (6/15 games 3-seed complete) + 10 running
- h066 IQN+OQE: 32/45 banked (3/15 games 3-seed complete) + 13 running
All 31 missing experiments covered by running jobs. No gaps.

### CORRECTED MULTI-SEED IQM COMPARISON (delta HNS vs PPO, 15 games):
| Algorithm | IQM dHNS | Median dHNS | W/L/T |
|-----------|----------|-------------|-------|
| h064 Rainbow-lite | +0.0102 | +0.0072 | 8/3/4 LEADER |
| h066 IQN+OQE | -0.0039 | +0.0042 | 7/4/4 |
| h063 IQN | -0.0042 | +0.0046 | 7/4/4 |

Rainbow-lite dominant (+0.0102 IQM). OQE vs IQN: IQM +0.0003 — negligible benefit.

### KEY FINDINGS (corrected):
- Enduro: Rainbow-lite +0.0254 vs PPO WIN. IQN +0.0026 (TIE), OQE +0.0025 (TIE). N-step+NoisyNet are the key Enduro ingredients.
- Venture: All near-TIE with PPO. IQN+0.0019, RBL+0.0038, OQE+0.0029.
- DoubleDunk remains the biggest differentiator: RBL -1.435 vs IQN -2.18, all catastrophic vs PPO.

### 31 RUNNING JOBS (~02:00 UTC Mar 23):
Seed-2 remaining (5 jobs, ~8h elapsed / 11h → ~3h):
- fir: h063-qbert-s2, h064-solaris-s2
- narval: h064-breakout-s2, h066-alien-s2, h066-solaris-s2

Seed-3 (26 jobs, ~2-5h elapsed / 11h → ~6-9h):
- fir (5): h063-enduro-s3, h063-qbert-s3, h064-battlezone-s3, h064-namethisgame-s3, h064-venture-s3, h066-enduro-s3, h066-qbert-s3
- narval (7): h063-amidar-s3, h063-mspacman-s3, h063-spaceinvaders-s3, h064-doubledunk-s3, h064-privateeye-s3, h066-amidar-s3, h066-mspacman-s3, h066-spaceinvaders-s3
- nibi (8): h063-breakout-s3, h063-phoenix-s3, h064-alien-s3, h064-montezumarevenge-s3, h064-solaris-s3, h066-breakout-s3, h066-doubledunk-s3, h066-montezumarevenge-s3, h066-phoenix-s3, h066-privateeye-s3, h066-solaris-s3

### ETA:
- Seed-2 completions: ~05:00 UTC Mar 23 (~3h)
- Seed-3 bulk completions: ~07:00-10:00 UTC Mar 23 (~5-8h)
- Full Phase 3 completion: ~10:00 UTC Mar 23
...
---
**[2026-03-23 02:01 UTC]**

## Session 208: Bank 5 results (h066-doubledunk-s3, h066-montezumarevenge-s3, h066-privateeye-s3, h066-solaris-s3, h064-solaris-s2) — 26 Phase 3 jobs running

### Triggered by: h066-doubledunk-s3, h066-montezumarevenge-s3, h066-privateeye-s3, h066-solaris-s3 (all nibi SUCCESS)

### RESULTS BANKED: 5
1. h064-solaris-s2: Rainbow-lite Solaris seed 2, q4=1532.87 (vs s1=1658.26). PPO s2=2468.84 LOSS (-37.9%). Found on fir, not yet banked.
2. h066-doubledunk-s3: IQN+OQE DoubleDunk seed 3, q4=-22.57. All 3 seeds complete. 3-seed avg q4=-22.57. PPO avg=-17.77 BIG LOSS. IQN avg=-22.56 TIE.
3. h066-montezumarevenge-s3: IQN+OQE MontezumaRevenge seed 3, q4=0.0 as expected. All 3 seeds complete. All zero.
4. h066-privateeye-s3: IQN+OQE PrivateEye seed 3, q4=643.87. All 3 seeds complete. 3-seed avg q4=622.37. IQN avg=411.66, OQE +51.2% better! PPO avg=-134.72 BIG WIN. Notable: OQE consistently better than IQN on PrivateEye across all 3 seeds.
5. h066-solaris-s3: IQN+OQE Solaris seed 3, q4=862.54 (vs s1=904.98). PPO s3=2207.27 LOSS (-60.9%). s2 still running.

### PHASE 3 COVERAGE:
- h001 PPO: 45/45 COMPLETE
- h063 IQN: 37/45 banked (8/15 games 3-seed complete) + 8 running
- h064 Rainbow-lite: 36/45 banked (6/15 games 3-seed complete) + 9 running
- h066 IQN+OQE: 36/45 banked (6/15 games 3-seed complete) + 9 running
All 26 missing experiments covered by running jobs. No gaps.
...
Rainbow-lite dominant. OQE adds minor benefit vs vanilla IQN (+0.0003 IQM). OQE's advantage is most visible on PrivateEye (+51.2%).

### h066 (OQE) 3-SEED COMPLETE GAMES (6/15):
- Alien: OQE avg=308.11 vs IQN=311.24 TIE (-1%)
- BattleZone: OQE avg=3637.81 vs IQN=3306.86 WIN (+10%)
- DoubleDunk: OQE avg=-22.57 vs IQN=-22.56 TIE
- MontezumaRevenge: both zero TIE
- PrivateEye: OQE avg=622.37 vs IQN=411.66 WIN (+51.2%) — most significant OQE advantage
- Venture: OQE avg=3.47 vs IQN=3.86 TIE (-10%)

### 26 RUNNING JOBS (~02:00 UTC Mar 23):
Seed-2 remaining (3 jobs, ~8h elapsed / 11h → ~3h remaining):
- fir: h063-qbert-s2 (8h12m elapsed)
- narval: h064-breakout-s2 (8h10m), h066-alien-s2 (8h07m), h066-solaris-s2 (8h04m)

Seed-3 (22 jobs, ~2.5-3.5h elapsed / 11h → ~7.5-8.5h remaining):
- fir (5): h063-enduro-s3, h063-qbert-s3, h064-battlezone-s3, h064-namethisgame-s3, h064-venture-s3, h066-enduro-s3, h066-qbert-s3
- narval (7): h063-amidar-s3, h063-mspacman-s3, h063-spaceinvaders-s3, h064-doubledunk-s3, h064-privateeye-s3, h066-amidar-s3, h066-mspacman-s3, h066-spaceinvaders-s3
- nibi (6): h063-breakout-s3, h063-phoenix-s3, h064-alien-s3, h064-montezumarevenge-s3, h064-solaris-s3, h066-breakout-s3, h066-phoenix-s3

### ETA:
- Seed-2 completions: ~05:00 UTC Mar 23 (~3h)
- Seed-3 bulk completions: ~09:00-11:00 UTC Mar 23 (~7-9h)
- Full Phase 3 completion: ~11:00 UTC Mar 23
...
---
**[2026-03-23 02:12 UTC]**

## Session 209: Bank h066-alien-s2 — 25 Phase 3 jobs running

### Triggered by: h066-alien-s2 (job 58105321, narval SUCCESS)

### RESULT BANKED: 1
h066-alien-s2: IQN+OQE Alien seed 2, q4=309.54 (vs s1=310.64, s3=305.57). All 3 seeds now complete. 3-seed avg q4=308.58. PPO avg=196.87 WIN (+56.8%). IQN avg=311.24 TIE (-0.9%). OQE neutral on Alien.
...
All 25 missing experiments covered by running jobs. No gaps.

### h066 (OQE) 3-SEED COMPLETE GAMES (7/15):
- Alien: OQE avg=308.58 vs IQN=311.24 TIE (-0.9%)
- BattleZone: OQE avg=3637.81 vs IQN=3306.86 WIN (+10%)
- DoubleDunk: OQE avg=-22.57 vs IQN=-22.56 TIE
- MontezumaRevenge: both zero TIE
- NameThisGame: OQE avg=1633.15 vs IQN 3-seed TBD
- PrivateEye: OQE avg=622.37 vs IQN=411.66 WIN (+51.2%)
- Venture: OQE avg=3.47 vs IQN=3.86 TIE (-10%)

### 25 RUNNING JOBS (~02:30 UTC Mar 23):
Seed-2 remaining (3 jobs, ~8.5h elapsed / 11h → ~2.5h remaining):
- fir: h063-qbert-s2 (~8.5h elapsed)
- narval: h064-breakout-s2, h066-solaris-s2

Seed-3 (22 jobs, ~3-4h elapsed / 11h → ~7-8h remaining):
- fir (6): h063-enduro-s3, h063-qbert-s3, h064-battlezone-s3, h064-namethisgame-s3, h064-venture-s3, h066-enduro-s3, h066-qbert-s3
- narval (8): h063-amidar-s3, h063-mspacman-s3, h063-spaceinvaders-s3, h064-doubledunk-s3, h064-privateeye-s3, h066-amidar-s3, h066-mspacman-s3, h066-spaceinvaders-s3
- nibi (6): h063-breakout-s3, h063-phoenix-s3, h064-alien-s3, h064-montezumarevenge-s3, h064-solaris-s3, h066-breakout-s3, h066-phoenix-s3

### ETA:
- Seed-2 completions: ~05:00 UTC Mar 23 (~2.5h)
- Seed-3 bulk completions: ~09:00-10:00 UTC Mar 23 (~7-8h)
- Full Phase 3 completion: ~10:00 UTC Mar 23
...
---
**[2026-03-23 03:51 UTC]**

## Session 213: Bank h066-phoenix-s3 — 20 Phase 3 jobs running

### Triggered by: h066-phoenix-s3 (job 10769703, nibi SUCCESS)

### RESULT BANKED: 1
h066-phoenix-s3: IQN+OQE Phoenix seed 3, q4=147.66 (vs s1=139.71, s2=141.33). All 3 OQE Phoenix seeds now complete. 3-seed avg q4=142.90. PPO avg=796.16 BIG LOSS (-82.1%). IQN s1=134.16, s2=137.49 (s3 still running). OQE slightly better than IQN (+4-8% on Phoenix).

### PHASE 3 COVERAGE:
- h001 PPO: 45/45 COMPLETE
- h063 IQN: 37/45 banked (8/15 games 3-seed complete) + 8 running
- h064 Rainbow-lite: 39/45 banked (9/15 games 3-seed complete) + 6 running
- h066 IQN+OQE: 39/45 banked (9/15 games 3-seed complete) + 6 running
All 20 missing experiments covered by running jobs. No gaps.

### h066 (OQE) 3-SEED COMPLETE GAMES (9/15):
- Alien: avg=308.58 vs IQN=311.24 TIE (-0.9%)
- BattleZone: avg=3637.81 vs IQN=3306.86 WIN (+10%)
- DoubleDunk: avg=-22.57 vs IQN=-22.56 TIE
- MontezumaRevenge: both zero TIE
- NameThisGame: avg=1633.15 vs IQN=1656.88 TIE (-1.4%)
- Phoenix: avg=142.90 vs IQN ~135.83 (2 seeds) WIN (+5.2%)
- PrivateEye: avg=622.37 vs IQN=411.66 WIN (+51.2%)
- Solaris: avg=852.97 vs IQN=778.38 WIN (+9.6%)
- Venture: avg=3.47 vs IQN=3.86 TIE (-10%)

OQE vs IQN pattern: OQE wins on PrivateEye (+51%), Solaris (+10%), BattleZone (+10%), Phoenix (+5%). Ties on Alien, DoubleDunk, MontezumaRevenge, NTG, Venture. No significant OQE losses.

### 20 RUNNING JOBS (~03:50 UTC Mar 23):
- fir (5): h063-qbert-s2 (10:05h/11h → ~1h!), h063-enduro-s3, h063-qbert-s3, h064-battlezone-s3, h066-enduro-s3, h066-qbert-s3
- narval (8): h063-amidar-s3, h063-mspacman-s3, h063-spaceinvaders-s3, h064-doubledunk-s3, h064-privateeye-s3, h066-amidar-s3, h066-mspacman-s3, h066-spaceinvaders-s3
- nibi (6): h063-breakout-s3, h063-phoenix-s3, h064-alien-s3, h064-montezumarevenge-s3, h064-solaris-s3, h066-breakout-s3

### ETA:
- h063-qbert-s2 (fir): ~04:45 UTC Mar 23 (~1h)
- Seed-3 bulk completions: ~08:30-09:30 UTC Mar 23 (~5-6h)
...
## Session 214: Bank h063-breakout-s3 + h063-phoenix-s3 + h064-montezumarevenge-s3 — 17 Phase 3 jobs running

### Triggered by: h063-breakout-s3 (job 10769679, nibi SUCCESS), h064-montezumarevenge-s3 (job 10769692, nibi SUCCESS)
### Also detected: h063-phoenix-s3 (job 10769690, nibi SUCCESS)

### RESULTS BANKED: 3
1. h063-breakout-s3: IQN Breakout seed 3, q4=1.79 (vs s1=1.85, s2=1.85). All 3 seeds complete. 3-seed avg q4=1.83. PPO avg=1.50 WIN (+22%).
2. h064-montezumarevenge-s3: Rainbow-lite MR seed 3, q4=0.0 (vs s1=0.0, s2=0.04). All 3 seeds complete. TIE — no algorithm solves this.
3. h063-phoenix-s3: IQN Phoenix seed 3, q4=142.23 (vs s1=134.16, s2=137.49). All 3 seeds complete. 3-seed avg q4=137.96. PPO avg=796.16 BIG LOSS (-82.7%). OQE avg=142.90 slightly better than IQN (+3.6%).

### PHASE 3 COVERAGE:
- h001 PPO: 45/45 COMPLETE
- h063 IQN: 39/45 banked (10/15 games 3-seed complete) + 6 running
- h064 Rainbow-lite: 40/45 banked (10/15 games 3-seed complete) + 5 running
- h066 IQN+OQE: 39/45 banked (9/15 games 3-seed complete) + 6 running
All 17 missing experiments covered by running jobs. No gaps.

### h063 (IQN) 3-SEED COMPLETE GAMES (10/15):
- Alien: avg=311.24 vs PPO=196.87 WIN (+58.1%)
- BattleZone: avg=3306.86 (2 seeds)
- Breakout: avg=1.83 vs PPO=1.50 WIN (+22%) — NEW
- DoubleDunk: avg=-22.56 vs PPO=-17.77 LOSS
- MontezumaRevenge: both zero TIE
- NameThisGame: avg=1656.88
- Phoenix: avg=137.96 vs PPO=796.16 BIG LOSS (-82.7%) — NEW
- PrivateEye: avg=411.66
- Solaris: avg=778.38 vs PPO=2279.89 BIG LOSS
- Venture: avg=3.86

### h064 (Rainbow-lite) 3-SEED COMPLETE GAMES (10/15):
Amidar, Breakout, Enduro, MontezumaRevenge, MsPacman, NameThisGame, Phoenix, Qbert, SpaceInvaders, Venture
Remaining (5 running): Alien-s3, BattleZone-s3, DoubleDunk-s3, PrivateEye-s3, Solaris-s3

### 17 RUNNING JOBS (~04:00 UTC Mar 23):
- h063-qbert-s2 (fir): 10.1h elapsed — completing any minute!
- narval seed-3 (8): ~5.6h elapsed → ~4.4h remaining → ETA ~08:22 UTC
- fir seed-3 (4): ~5.5-5.6h elapsed → ~4.4-4.5h remaining → ETA ~08:22-08:31 UTC
- nibi seed-3 (3): ~4.7-5.0h elapsed → ~5.0-5.3h remaining → ETA ~09:00-09:17 UTC

### ETA:
- h063-qbert-s2: IMMINENT (~minutes)
- Seed-3 bulk (narval+fir): ~08:00-09:00 UTC Mar 23
- Seed-3 nibi: ~09:00-09:30 UTC Mar 23
- Full Phase 3 completion: ~09:30 UTC Mar 23

### NEXT SESSION TODO:
1. Bank remaining results as they arrive
2. After 45/45 for each: compute final 3-seed IQM with bootstrap confidence intervals
3. Final comparison: h064 Rainbow-lite vs h066 OQE vs h063 IQN vs h001 PPO
...
## Session 215: Bank h064-doubledunk-s3 — 16 Phase 3 jobs running

### Triggered by: h064-doubledunk-s3 (job 58109782, narval SUCCESS)

### RESULT BANKED: 1
h064-doubledunk-s3: Rainbow-lite DoubleDunk seed 3, q4=-33.73 (vs s1=-19.35, s2=-22.51). HIGH VARIANCE OUTLIER. 3-seed avg q4=-25.20. PPO avg=-17.77 BIG LOSS (-42%). IQN avg=-22.56 LOSS (-12%). OQE avg=-22.43 LOSS (-12%). Rainbow-lite has worst DoubleDunk variance of all methods.

### PHASE 3 COVERAGE:
- h001 PPO: 45/45 COMPLETE
- h063 IQN: 39/45 banked (10/15 games 3-seed) + 6 running (qbert-s2, amidar-s3, enduro-s3, mspacman-s3, qbert-s3, spaceinvaders-s3)
- h064 Rainbow-lite: 41/45 banked (11/15 games 3-seed) + 4 running (alien-s3, battlezone-s3, privateeye-s3, solaris-s3)
...
All 16 missing experiments covered by running jobs. No gaps.

### IQM COMPARISON (delta HNS vs PPO, 15 games):
| Algorithm | IQM dHNS | Median dHNS | W/L/T |
|-----------|----------|-------------|-------|
| h064 Rainbow-lite | +0.0093 | +0.0072 | 8/3/4 LEADER |
| h066 IQN+OQE | -0.0039 | +0.0042 | 7/4/4 |
| h063 IQN | -0.0043 | +0.0046 | 7/4/4 |

Rainbow-lite still leads despite terrible DoubleDunk s3 (-33.73). The outlier gets trimmed by IQM. OQE slightly beats IQN (+0.0004 IQM).

### KEY OBSERVATION: DoubleDunk distortion
DoubleDunk's tiny human-random range (2.2 points) amplifies any score difference. All DQN variants lose vs PPO on DoubleDunk raw scores (~-22 to -25 vs PPO ~-18), but the HNS delta is extreme (-2 to -3). IQM properly handles this by trimming.

### h063-qbert-s2 status:
Still legitimately running on fir: 10:22/11:00 elapsed. Should complete in ~37 min.

### 16 RUNNING JOBS (~21:10 UTC Mar 22):
- fir (5): h063-qbert-s2 (10:22/11:00!), h063-enduro-s3 (5:45/11), h063-qbert-s3 (5:45/11), h064-battlezone-s3 (5:44/11), h066-enduro-s3 (5:41/11), h066-qbert-s3 (5:34/11)
- narval (6): h063-amidar-s3, h063-mspacman-s3, h063-spaceinvaders-s3, h064-privateeye-s3, h066-amidar-s3, h066-mspacman-s3, h066-spaceinvaders-s3
- nibi (3): h064-alien-s3, h064-solaris-s3, h066-breakout-s3

### ETA:
- h063-qbert-s2: ~37 min
- Seed-3 fir: ~5h remaining
- Seed-3 narval/nibi: ~5-6h remaining
- Full Phase 3 completion: ~10:00-11:00 UTC Mar 23

### NEXT SESSION TODO:
1. Bank h063-qbert-s2 when it arrives
...
---
**[2026-03-23 04:19 UTC]**

## Session 217: Bank h066-breakout-s3 — 12 Phase 3 jobs running

### Triggered by: h066-breakout-s3 (job 10769697, nibi SUCCESS)

### RESULT BANKED: 1
h066-breakout-s3: IQN+OQE Breakout seed 3, q4=1.76 (vs s1=1.79, s2=1.83). All 3 OQE Breakout seeds now complete. 3-seed avg q4=1.795. PPO avg=1.50 WIN (+20%). IQN avg=1.83 — OQE marginally lower (-1.9%). Rainbow-lite avg=2.02 — both IQN variants lose on Breakout vs Rainbow-lite. Near-zero game (~1.8/864 possible) so difference is negligible.

### PHASE 3 COVERAGE:
- h001 PPO: 45/45 COMPLETE
- h063 IQN: 41/45 banked (remaining: amidar-s3, enduro-s3, mspacman-s3, qbert-s2) + 4 running
- h064 Rainbow-lite: 42/45 banked (remaining: battlezone-s3, privateeye-s3, solaris-s3) + 3 running
- h066 IQN+OQE: 40/45 banked (remaining: amidar-s3, enduro-s3, mspacman-s3, qbert-s3, spaceinvaders-s3) + 5 running
All 12 missing experiments covered by running jobs. No gaps.

### h066 (OQE) 3-SEED COMPLETE GAMES (10/15):
Alien, BattleZone, Breakout, DoubleDunk, MontezumaRevenge, NameThisGame, Phoenix, PrivateEye, Solaris, Venture

### 12 RUNNING JOBS (~04:35 UTC Mar 23):
- fir (5): h063-qbert-s2 (10:33/11:00 → ~27 min!), h063-enduro-s3, h064-battlezone-s3, h066-enduro-s3, h066-qbert-s3 (~5:00 remaining)
- narval (5): h063-amidar-s3, h063-mspacman-s3, h064-privateeye-s3, h066-amidar-s3, h066-mspacman-s3, h066-spaceinvaders-s3 (~5:00 remaining)
- nibi (1): h064-solaris-s3 (~5:00 remaining)

### ETA:
- h063-qbert-s2 (fir): ~05:00 UTC Mar 23 (~27 min)
- Seed-3 bulk completions: ~10:00-11:00 UTC Mar 23
- Full Phase 3 completion: ~10:30 UTC Mar 23

### NEXT SESSION TODO:
1. Bank h063-qbert-s2 when it arrives (~27 min)
2. Bank remaining seed-3 results as they complete
3. After 45/45 for each: compute final 3-seed IQM with bootstrap confidence intervals
4. Final comparison: h064 Rainbow-lite vs h066 OQE vs h063 IQN vs h001 PPO

---
**[2026-03-23 04:23 UTC]**

## Session 218: Bank h064-solaris-s3 — 11 Phase 3 jobs running

### Triggered by: h064-solaris-s3 (job 10769695, nibi SUCCESS)

### RESULT BANKED: 1
h064-solaris-s3: Rainbow-lite Solaris seed 3, q4=1735.04 (vs s1=1658.26, s2=1532.87). All 3 Rainbow-lite Solaris seeds now complete. 3-seed avg q4=1642.06. PPO avg=2279.89 LOSS (-28.0%). IQN avg=778.38 BIG WIN (+111.0%). OQE avg=852.97 BIG WIN (+92.5%). Solaris is a LOSS vs PPO for all DQN variants, but Rainbow-lite is by far the best DQN variant on Solaris.

### PHASE 3 COVERAGE:
- h001 PPO: 45/45 COMPLETE
- h063 IQN: 41/45 banked (remaining: amidar-s3, enduro-s3, mspacman-s3, qbert-s2) + 4 running
- h064 Rainbow-lite: 43/45 banked (13/15 games 3-seed complete) + 2 running (battlezone-s3, privateeye-s3)
- h066 IQN+OQE: 40/45 banked (10/15 games 3-seed complete) + 5 running (amidar-s3, enduro-s3, mspacman-s3, qbert-s3, spaceinvaders-s3)
All 11 missing experiments covered by running jobs. No gaps.

### h064 (Rainbow-lite) 3-SEED COMPLETE GAMES (13/15):
Alien, Amidar, Breakout, DoubleDunk, Enduro, MontezumaRevenge, MsPacman, NameThisGame, Phoenix, Qbert, Solaris, SpaceInvaders, Venture
Remaining (2 running): BattleZone-s3, PrivateEye-s3

### 11 RUNNING JOBS (~04:25 UTC Mar 23):
- fir (5): h063-qbert-s2 (10:38/11:00 → ~22 min!), h063-enduro-s3 (6:04/11), h064-battlezone-s3 (6:02/11), h066-enduro-s3 (6:00/11), h066-qbert-s3 (5:53/11)
- narval (6): h063-amidar-s3, h063-mspacman-s3, h064-privateeye-s3, h066-amidar-s3, h066-mspacman-s3, h066-spaceinvaders-s3 (~6:02/11)

### ETA:
- h063-qbert-s2 (fir): ~04:50 UTC Mar 23 (~22 min)
- Seed-3 bulk (fir+narval): ~09:30-10:00 UTC Mar 23
- Full Phase 3 completion: ~10:00 UTC Mar 23

### NEXT SESSION TODO:
1. Bank h063-qbert-s2 when it arrives (~22 min)
...
---
**[2026-03-23 19:12 UTC]**

## Session 238: Status check — banked 1 new Phase 4 result, 425 jobs still active.

### Triggered by: h002-robotank-s1 (nibi) — 10M wrong batch, NOT banked.

### NEW RESULT BANKED:
- h002-bankheist-s1 (rorqual): 40M confirmed, q4=9.57. Phase 4 new-game result #2 for PQN.

### PHASE 4 STATUS (19:15 UTC Mar 23):
Active SLURM jobs: 425 total (184 running + 241 pending)
- h001 PPO (40M): 36 running, 111 pending → first completions ~20:00-20:30 UTC
- h002 PQN (40M): 33 running, 119 pending → first completions ~20:00-20:30 UTC
- h064 Rainbow-lite (40M): 116 running, 10 pending → first completions ~23:00+ UTC

### BANKED TOTALS:
- h001 PPO: 45 (orig15 complete, 0 Phase 4 new-game)
- h002 PQN: 47 (45 orig15 + 2 Phase 4: Assault q4=369.08, BankHeist q4=9.57)
- h064 Rainbow-lite: 45 (orig15 complete, 0 Phase 4 new-game)
- Need: 42 new games × 3 seeds × 3 algorithms = ~378 more results

### NEXT SESSION TODO:
1. Bank h001/h002 40M Phase 4 results (first wave ~20:00-20:30 UTC)
2. Bank h064 Phase 4 results (~23:00+ UTC)
...
---
**[2026-03-23 19:29 UTC]**

## Session 240: Banked 6 Phase 4 40M new-game results. Phase 4 progressing across all clusters.

### Triggered by: h001-berzerk-s2 (rorqual), h002-berzerk-s3 (rorqual), h002-demonattack-s2 (rorqual), h002-timepilot-s2 (fir)

### RESULTS:
3 triggered from rorqual are 40M (BANKED), 1 from fir is 10M (wrong batch, NOT banked).
Also found via check-completions: h001-surround-s3 (fir, 10M), h002-tennis-s1 (fir, 10M) — NOT banked.
Also found h001-asterix-s1 (rorqual, 40M), h001-bowling-s3 (rorqual, 40M), h002-asterix-s2 (rorqual, 40M) via CSV scan — BANKED.

### BANKED THIS SESSION (6 new):
- h001-asterix-s1: Asterix-v5 PPO q4=249.02 (rorqual)
- h001-berzerk-s2: Berzerk-v5 PPO q4=163.46 (rorqual)  
- h001-bowling-s3: Bowling-v5 PPO q4=22.03 (rorqual)
- h002-asterix-s2: Asterix-v5 PQN q4=400.45 (rorqual)
- h002-berzerk-s3: Berzerk-v5 PQN q4=279.94 (rorqual)
- h002-demonattack-s2: DemonAttack-v5 PQN q4=922.22 (rorqual)

### PHASE 4 BANKING TOTALS:
- h001 PPO: 48 banked (45 orig15 + 3 new: Asterix/Berzerk/Bowling)
- h002 PQN: 52 banked (45 orig15 + 7 new: Assault/Asterix/Asteroids/BankHeist/Berzerk/Centipede/DemonAttack)
- h064 Rainbow-lite: 45 banked (orig15 only, 0 new — 11h jobs still running)
- Target: 171 per algorithm (57 games × 3 seeds)

### SLURM QUEUE STATUS (19:30 UTC Mar 23):
| Cluster | h001 run/pend | h002 run/pend | h064 run/pend | Max elapsed |
|---------|---------------|---------------|---------------|-------------|
| rorqual | 18/9 | 18/10 | 32/0 | h001/h002: 2.2h, h064: 2.9h |
| fir | 6/31 | 4/33 | 31/0 | h001: 2.2h, h064: 2.7h |
| narval | 3/30 | 4/32 | 31/0 | h064: 3.3h |
| nibi | 1/37 | 1/40 | 25/7 | h064: 3.4h |
Total: 174 running + 229 pending = 403 active SLURM jobs

### ESTIMATED COMPLETIONS:
- h001/h002 first big wave (rorqual): ~20:15-20:30 UTC Mar 23 (~45 min)
- h001/h002 second wave (fir): ~20:30-21:00 UTC
- h064 first completions: ~03:00-04:00 UTC Mar 24
- Full Phase 4 completion ETA: ~12:00-18:00 UTC Mar 24

### NOTE ON h001B/h002B CSVs:
Found 40M CSVs for h001B/h002B experiments across all clusters. These have different format (no q4_return column). They are human-managed experiments for orig15 games only — IGNORING.

### NEXT SESSION TODO:
1. Bank h001/h002 40M results as they arrive (big wave from rorqual in ~45 min)
2. Bank h064 results (~03:00+ UTC Mar 24)
3. VERIFY total_timesteps=40000000 before banking
4. Begin Atari57 IQM analysis when >20 new games banked per algorithm
5. Full Phase 4 completion ETA: ~12:00-18:00 UTC Mar 24

---
**[2026-03-23 19:37 UTC]**

## Session 241: Banked 11 Phase 4 40M new-game results. Rorqual producing first wave of h001/h002 completions.

### Triggered by: h001-atlantis-s3 (rorqual), h001-beamrider-s1 (rorqual), h002-boxing-s1 (rorqual), h002-gravitar-s3 (rorqual), h001-zaxxon-s2 (narval), h001-timepilot-s1 (fir), h001-tutankham-s2 (fir)

### RESULTS:
- 4 rorqual triggers: ALL 40M, BANKED
- 3 narval/fir triggers: ALL 10M (wrong batch), NOT banked
- Also found via check-completions + CSV scan: h001-crazyclimber-s3, h001-gopher-s1, h002-choppercommand-s3, h001-choppercommand-s2, h002-beamrider-s2, h002-gopher-s2, h002-jamesbond-s2 (all rorqual, 40M, BANKED)

### BANKED THIS SESSION (11 new):
h001 PPO (5): Atlantis q4=15848, BeamRider q4=338, ChopperCommand q4=846, CrazyClimber q4=7845, Gopher q4=309
h002 PQN (6): BeamRider q4=623, Boxing q4=-34.4, ChopperCommand q4=904, Gopher q4=44, Gravitar q4=46, Jamesbond q4=9.3

### PHASE 4 BANKING TOTALS:
- h001 PPO: 53 banked (45 orig15 + 8 new42 across 8 games)
- h002 PQN: 58 banked (45 orig15 + 13 new42 across 13 games)
- h064 Rainbow-lite: 45 banked (orig15 only, 0 new42 — 11h jobs still running)
- Target: 171 per algorithm (57 games × 3 seeds)

### SLURM QUEUE STATUS (19:40 UTC Mar 23):
- h001 PPO: 25 running + 106 pending = 131 active
- h002 PQN: 21 running + 114 pending = 135 active
- h064 Rainbow-lite: 119 running + 7 pending = 126 active
- Total: 392 active SLURM jobs across 4 clusters

### KEY OBSERVATION:
Rorqual is the first cluster producing 40M h001/h002 results (jobs submitted ~17:00 UTC, completing at ~19:15+). 
Narval/fir/nibi still have 10M wrong-batch results for h001/h002 — their 40M jobs haven't completed yet.
h064 Rainbow-lite (11h walltime) won't produce results until ~03:00-04:00 UTC Mar 24.

### NEXT SESSION TODO:
1. Bank more h001/h002 40M results as they arrive from all clusters
2. Bank h064 Phase 4 results (~03:00+ UTC Mar 24)
3. VERIFY total_timesteps=40000000 before banking (bank_phase4.py handles this automatically)
4. Begin Atari57 IQM analysis when >20 new games banked per algorithm
5. Full Phase 4 completion ETA: ~06:00-08:00 UTC Mar 24

---
**[2026-03-23 19:43 UTC]**

## Session 242: Banked 3 Phase 4 40M new-game results (h001-gravitar-s2, h002-defender-s1, h002-frostbite-s1)

### Triggered by: h002-defender-s1, h002-frostbite-s1, h001-gravitar-s2 (all rorqual SUCCESS)

### NEW RESULTS BANKED:
- h001-gravitar-s2: Gravitar-v5 PPO q4=196.80 (rorqual)
- h002-defender-s1: Defender-v5 PQN q4=2458.87 (rorqual)
- h002-frostbite-s1: Frostbite-v5 PQN q4=99.97 (rorqual)

### PHASE 4 BANKING TOTALS:
- h001 PPO: 54 banked (45 orig15 + 9 new42 across 9 games, 24 total games)
- h002 PQN: 60 banked (45 orig15 + 15 new42 across 15 games, 30 total games)
- h064 Rainbow-lite: 45 banked (orig15 only, 0 new42 — 11h jobs at 3.6h elapsed)
- Target: 171 per algorithm (57 games × 3 seeds)

### SLURM QUEUE STATUS (19:42 UTC Mar 23):
- h001 PPO: 25 running (max 2.5h elapsed), 103 pending → next completions in ~30 min
- h002 PQN: 21 running (max 2.2h elapsed), 111 pending → next completions in ~45 min
- h064 Rainbow-lite: 119 running (3.6h/11h elapsed), 7 pending → ~7h remaining
- Total: 165 running + 221 pending = 386 active SLURM jobs across 4 clusters

### CROSS-CLUSTER PROGRESS:
- narval: 24 h001/h002 40M CSVs, 65 still 10M; 13 h064 40M CSVs
- fir: 24 h001/h002 40M CSVs, 56 still 10M; 15 h064 40M CSVs  
- nibi: 22 h001/h002 40M CSVs, 46 still 10M; 16 h064 40M CSVs
- rorqual: leading in completions (first cluster to finish h001/h002 new-game jobs)
- All 40M CSVs across all clusters already banked (bank_phase4.py working correctly)

### NEXT SESSION TODO:
1. Bank more h001/h002 40M results as they arrive (~30 min for next wave from rorqual)
2. Bank h064 Phase 4 results (~03:00+ UTC Mar 24)
3. VERIFY total_timesteps=40000000 before banking (bank_phase4.py handles this)
4. Begin Atari57 IQM analysis when >30 games banked per algorithm
5. Full Phase 4 completion ETA: ~06:00-08:00 UTC Mar 24

---
**[2026-03-23 19:53 UTC]**

## Session 243: Banked 5 Phase 4 40M new-game results. Phase 4 progressing.

### Triggered by: h001-centipede-s1 (rorqual SUCCESS), h001-skiing-s2 (nibi SUCCESS)

### NEW RESULTS BANKED (5):
h001 PPO (3): Centipede-v5 q4=2235.36, Asteroids-v5 q4=815.85, DemonAttack-v5 q4=147.06
h002 PQN (2): IceHockey-v5 q4=-13.16, Kangaroo-v5 q4=355.56

### NOTE: h001-skiing-s2 from nibi is STILL 10M (wrong batch) — 40M job not yet completed there.

### PHASE 4 BANKING TOTALS:
- h001 PPO: 57 banked (45 orig15 + 12 new42), 27 unique games
- h002 PQN: 62 banked (45 orig15 + 17 new42), 32 unique games
- h064 Rainbow-lite: 45 banked (orig15 only, 0 new42 — 119 running, ~7h remaining)
- Target: 171 per algorithm (57 games × 3 seeds), total 513

### 40M CSV STATUS BY CLUSTER (h001/h002 new-game only):
- rorqual: 48 at 40M (leading), 37 still 10M
- narval: 24 at 40M, 65 still 10M
- fir: 24 at 40M, 57 still 10M
- nibi: 22 at 40M, 47 still 10M

### SLURM QUEUE STATUS (~19:55 UTC Mar 23):
- h001 PPO: 21 running, pending in SLURM queue
- h002 PQN: 15 running, pending in SLURM queue
- h064 Rainbow-lite: 119 running, 7 pending
- Total: 155 running (DB), 218 pending (SLURM)

### NEXT SESSION TODO:
1. Bank more h001/h002 40M results as rorqual/other clusters complete
2. Bank h064 Phase 4 results (~03:00+ UTC Mar 24)
3. VERIFY total_timesteps=40000000 before banking (bank_phase4.py handles this)
4. Begin Atari57 IQM analysis when >30 games banked per algorithm
5. Full Phase 4 completion ETA: ~06:00-10:00 UTC Mar 24

---
**[2026-03-23 19:57 UTC]**

## Session 244: Banked 2 Phase 4 40M new-game results (h002 PQN: FishingDerby/Pong)

### Triggered by: h002-fishingderby-s3 (rorqual SUCCESS)

### NEW RESULTS BANKED (2):
- h002-fishingderby-s3: FishingDerby-v5 PQN q4=-95.82 (rorqual)
- h002-pong-s3: Pong-v5 PQN q4=-20.98 (rorqual)

### PHASE 4 BANKING TOTALS:
- h001 PPO: 57 banked (45 orig15 + 12 new42), 27 unique games
- h002 PQN: 64 banked (45 orig15 + 19 new42), 34 unique games
- h064 Rainbow-lite: 45 banked (orig15 only, 0 new42 — all 119 h064 jobs still running)
- Target: 171 per algorithm (57 games × 3 seeds)

### SLURM QUEUE STATUS (~20:00 UTC Mar 23):
- rorqual: h001 10R/9P, h002 5R/10P, h064 32R
- fir: h001 9R/26P, h002 8R/27P, h064 31R
- narval: h001 4R/29P, h002 4R/31P, h064 31R
- nibi: h001 1R/36P, h002 0R/40P, h064 25R/7P
- Total: 375 active SLURM jobs

### NOTE: h002-pong-s3 result (q4=-20.98) is very poor — Pong is typically easy for PQN.
Likely correct though since this is with clipped rewards and episodic_life=True.

### NEXT SESSION TODO:
1. Bank more h001/h002 40M results as they arrive (rorqual fastest producer)
2. Bank h064 Phase 4 results (~03:00+ UTC Mar 24)
3. VERIFY total_timesteps=40000000 before banking (bank_phase4.py handles this)
4. Begin Atari57 IQM analysis when >30 new games banked per algorithm
5. Full Phase 4 completion ETA: ~06:00-10:00 UTC Mar 24

---
**[2026-03-23 20:04 UTC]**

## Session 245: Banked 1 Phase 4 40M new-game result (h001 PPO: Freeway q4=0.0)

### Triggered by: h002-pong-s3 (rorqual), h001-wizardofwor-s1 (fir), h002-wizardofwor-s2 (fir)

### RESULTS:
- h002-pong-s3 (rorqual): Already banked in previous session
- h001-wizardofwor-s1 (fir): 10M (wrong batch) — NOT banked
- h002-wizardofwor-s2 (fir): 10M (wrong batch) — NOT banked
- h001-freeway-s3 (rorqual): 40M confirmed via CSV pull — BANKED: Freeway-v5 PPO q4=0.0

### PHASE 4 BANKING TOTALS (20:05 UTC Mar 23):
- h001 PPO: 58 banked (45 orig15 + 13 new42), 28 unique games, 113 remaining
- h002 PQN: 64 banked (45 orig15 + 19 new42), 34 unique games, 107 remaining
- h064 Rainbow-lite: 45 banked (orig15 only, 0 new42), 15 unique games, 126 remaining
- Target: 171 per algorithm (57 games × 3 seeds)

### SLURM QUEUE STATUS (~20:02 UTC Mar 23):
| Cluster | h001 R/P | h002 R/P | h064 R/P | Total |
|---------|----------|----------|----------|-------|
| rorqual | 10R/8P   | 5R/9P    | 32R/0P   | 64    |
| fir     | 8R/26P   | 6R/27P   | 31R/0P   | 98    |
| narval  | 4R/29P   | 4R/31P   | 31R/0P   | 99    |
| nibi    | 1R/36P   | 0R/40P   | 25R/7P   | 109   |
| TOTAL   | 23R/99P  | 15R/107P | 119R/7P  | 370   |

### ESTIMATED COMPLETIONS:
- rorqual h001/h002: ~30 min (max 2h36m elapsed, ~3h total)
- fir/narval h001/h002: ~2-2.5h (recently started)
- nibi h001/h002: ~3h (just started)
- h064 all clusters: ~7-8h (max 3h54m elapsed, 11h walltime)

### NEXT SESSION TODO:
1. Bank more h001/h002 40M results as rorqual completes (next wave ~30 min)
2. Bank h064 Phase 4 results (~03:00+ UTC Mar 24)
3. fir/narval/nibi still producing 10M wrong-batch CSVs; 40M will follow
4. Begin Atari57 IQM analysis when >30 new games banked per algorithm
5. Full Phase 4 completion ETA: ~06:00-10:00 UTC Mar 24

---
**[2026-03-23 20:11 UTC]**

## Session 246: Banked 2 Phase 4 40M new-game results (h001 PPO: Pitfall, h002 PQN: Pitfall)

### Triggered by: h001-freeway-s3 (rorqual, already banked), h001-pitfall-s1 (rorqual), h002-pitfall-s2 (rorqual), h001-yarsrevenge-s2 (fir, 10M), h002-yarsrevenge-s3 (fir, 10M)

### NEW RESULTS BANKED (2):
- h001-pitfall-s1: Pitfall-v5 PPO q4=-342.41 (rorqual, 40M)
- h002-pitfall-s2: Pitfall-v5 PQN q4=-61.70 (rorqual, 40M)

### NOT BANKED:
- h001-freeway-s3: already banked last session
- h001-yarsrevenge-s2 (fir): 10M wrong batch — NOT banked
- h002-yarsrevenge-s3 (fir): 10M wrong batch — NOT banked

### PHASE 4 BANKING TOTALS (20:10 UTC Mar 23):
- h001 PPO: 59 banked (45 orig15 + 14 new42), 29 unique games
- h002 PQN: 65 banked (45 orig15 + 20 new42), 35 unique games
- h064 Rainbow-lite: 45 banked (orig15 only, 0 new42 — 119 running)
- Target: 171 per algorithm (57 games × 3 seeds)

### SLURM QUEUE STATUS (~20:10 UTC Mar 23):
- fir: 65R/31P, narval: 39R/60P, nibi: 26R/83P, rorqual: 45R/15P
- h001 PPO: ~22 running, ~96 pending
- h002 PQN: ~16 running, ~104 pending
- h064 Rainbow-lite: ~119 running, ~7 pending
- Total: ~176 running + 189 pending = 365 active SLURM jobs

### NOTE: Pitfall performance
- h001 PPO Pitfall q4=-342 (very poor, near worst possible)
- h002 PQN Pitfall q4=-62 (better but still negative)
- Pitfall is notoriously hard for all RL algorithms

### NEXT SESSION TODO:
1. Bank more h001/h002 40M results as rorqual/other clusters complete
2. Bank h064 Phase 4 results (still running, ~7-8h remaining)
3. VERIFY total_timesteps=40000000 before banking
4. Begin Atari57 IQM analysis when >30 new games banked per algorithm
...
## Session 247: Banked 5 Phase 4 40M new-game results

### Triggered by: h001-hero-s3, h001-jamesbond-s1, h002-kungfumaster-s1, h001-pong-s2 (all rorqual SUCCESS)

### NEW RESULTS BANKED (5):
h001 PPO (4): Hero-v5 q4=527.04, Jamesbond-v5 q4=32.81, Krull-v5 q4=1742.60, Pong-v5 q4=-20.22
h002 PQN (1): KungFuMaster-v5 q4=9.89

### PHASE 4 BANKING TOTALS (20:20 UTC Mar 23):
- h001 PPO: 63 banked (45 orig15 + 18 new42), 33 unique games
- h002 PQN: 66 banked (45 orig15 + 21 new42), 36 unique games
- h064 Rainbow-lite: 45 banked (orig15 only, 0 new42 — 119 running across all clusters)
- Target: 171 per algorithm (57 games × 3 seeds)

### SLURM QUEUE STATUS (~20:20 UTC Mar 23):
| Cluster | h001 R | h002 R | h064 R | Pending |
|---------|--------|--------|--------|---------|
| rorqual | 7      | 5      | 32     | 9       |
| fir     | 17     | 18     | 31     | 30      |
| narval  | 4      | 4      | 31     | 60      |
| nibi    | 1      | 0      | 25     | 83      |
| TOTAL   | 29R    | 27R    | 119R   | 182P    |
Total active SLURM: 359 jobs (177R + 182P)

### NEXT SESSION TODO:
1. Bank more h001/h002 40M results as they arrive from all clusters
2. Bank h064 Phase 4 results (still running, ~7h remaining)
3. Continue Atari57 Phase 4 — h001/h002 nearing 40% complete, h064 at 26%
4. Full Phase 4 completion ETA: ~06:00-12:00 UTC Mar 24

---
**[2026-03-23 20:21 UTC]**

## Session 248: Banked 1 Phase 4 40M result (h001-kangaroo-s2)

### Triggered by: h001-kangaroo-s2 (rorqual SUCCESS)

### NEW RESULTS BANKED (1):
- h001-kangaroo-s2: Kangaroo-v5 PPO q4=39.52 (rorqual, 40M)

### PHASE 4 BANKING TOTALS (20:25 UTC Mar 23):
- h001 PPO: 64 banked (34 unique games, 15 with 3 seeds), 23 games missing
- h002 PQN: 66 banked (36 unique games, 15 with 3 seeds), 21 games missing
- h064 Rainbow-lite: 45 banked (15 unique games orig15 only), 42 new games still running
- Target: 171 per algorithm (57 games × 3 seeds)

### SLURM QUEUE STATUS (~20:25 UTC Mar 23):
| Cluster | h001 R/P | h002 R/P | h064 R/P | Max elapsed |
|---------|----------|----------|----------|-------------|
| rorqual | 8R/4P    | 7R/4P    | 32R/0P   | 8 min       |
| fir     | 18R/14P  | 19R/14P  | 31R/0P   | 54 min      |
| narval  | 4R/29P   | 4R/31P   | 31R/0P   | 52 min      |
| nibi    | 1R/36P   | 0R/40P   | 25R/7P   | 4h13m       |
Total: 180R/179P = 359 active SLURM jobs

### OBSERVATIONS:
- Rorqual just started new h001/h002 wave (8 min elapsed) — previous wave completed
- fir/narval h001/h002 at ~50 min, expect completions in ~2-2.5h
- nibi h064 at 4h13m/11h walltime — ~7h remaining
- h002-alien-s3 CSV was already banked in a prior session

### NEXT SESSION TODO:
1. Bank more h001/h002 40M results as rorqual/fir/narval complete (~2-3h)
2. Bank h064 Phase 4 results (nibi/narval/fir h064 at ~4h, 7h remaining)
3. Begin Atari57 IQM analysis when >40 games covered per h001/h002
4. Full Phase 4 completion ETA: ~06:00-12:00 UTC Mar 24

---
**[2026-03-23 20:27 UTC]**

## Session 249: Banked 2 Phase 4 40M results (h001 PPO: FishingDerby, h064 Rainbow-lite: Assault)

### Triggered by: h001-fishingderby-s2 (rorqual SUCCESS), h001-stargunner-s3 (nibi SUCCESS — but CSV is 10M wrong batch)

### NEW RESULTS BANKED (2):
- h001-fishingderby-s2: FishingDerby-v5 PPO q4=-93.83 (rorqual, 40M)
- h064-assault-s1: Assault-v5 Rainbow-lite q4=362.91 (found via pull+scan, first h064 new-game result!)

### NOT BANKED:
- h001-stargunner-s3 (nibi): CSV shows 10M (wrong batch) — 40M job not yet completed

### PHASE 4 BANKING TOTALS (20:30 UTC Mar 23):
- h001 PPO: 65 banked (45 orig15 + 20 new42), 35 unique games
- h002 PQN: 66 banked (45 orig15 + 21 new42), 36 unique games
- h064 Rainbow-lite: 46 banked (45 orig15 + 1 new42), 16 unique games (first new game: Assault!)
- Target: 171 per algorithm (57 games × 3 seeds)

### SLURM QUEUE STATUS (~20:30 UTC Mar 23):
| Cluster | h001 R/P | h002 R/P | h064 R/P | Total |
|---------|----------|----------|----------|-------|
| rorqual | 11R/0P   | 10R/1P   | 32R/0P   | 54    |
| fir     | 18R/14P  | 19R/14P  | 31R/0P   | 96    |
| narval  | 4R/29P   | 4R/31P   | 31R/0P   | 99    |
| nibi    | 0R/36P   | 1R/39P   | 24R/7P   | 107   |
| TOTAL   | 33R/79P  | 34R/85P  | 118R/7P  | 356   |

### ESTIMATED COMPLETIONS:
- rorqual h001/h002: just started new wave (~3 min elapsed), completions in ~3h
- fir h001/h002: ~9 min elapsed, completions in ~3h
- narval h001/h002: ~50-60 min elapsed, completions in ~2h
- nibi h001/h002: mostly pending, slower start
- h064 all clusters: 3.6-4.3h elapsed out of 11h, ~6-7h remaining

### MILESTONE: First h064 Rainbow-lite new-game result banked (Assault q4=362.91)
h064 jobs started completing! More h064 results expected around 03:00-04:00 UTC Mar 24.
...
---
**[2026-03-24 00:31 UTC]**

## Session 259: Banked 21 Phase 4 40M results (h001×3, h002×10, h064×8)

### Triggered by: 19 completions across rorqual/narval/nibi

### NEW RESULTS BANKED (21):
- h001 PPO (3): Atlantis-s2, Berzerk-s1, CrazyClimber-s2
- h002 PQN (10): Asteroids-s2, Atlantis-s3, BeamRider-s1, Boxing-s2, Centipede-s1, ChopperCommand-s2, CrazyClimber-s1, CrazyClimber-s3, Defender-s2, DemonAttack-s1, Amidar-s1
- h064 Rainbow-lite (8): Freeway-s1, KungFuMaster-s1, Riverraid-s2, RoadRunner-s2, Surround-s2, Tennis-s1, WizardOfWor-s2, YarsRevenge-s3

### PHASE 4 BANKING TOTALS (00:40 UTC Mar 24):
- h001 PPO: 90/171 banked, 49/57 games (17 with 3 seeds), 81 remaining
...
### SLURM QUEUE STATUS (~00:40 UTC Mar 24):
| Cluster | h001 R/P | h002 R/P | h064 R/P | Total |
|---------|----------|----------|----------|-------|
| rorqual | 25R/8P   | 13R/13P  | 17R/18P  | 94    |
| narval  | 17R/40P  | 17R/36P  | 2R/32P   | 144   |
| nibi    | 22R/33P  | 21R/27P  | 7R/34P   | 144   |
| fir     | 5R/40P   | 5R/35P   | 0R/32P   | 117   |
| TOTAL   | 69R/121P | 56R/111P | 26R/116P | 499   |

### GAP CHECK: No true gaps — all 513 experiments either banked or in SLURM queue

### NEXT SESSION TODO:
1. Bank more results as jobs complete
2. h064 closest to done (131/171, 76.6%), h001/h002 still building
3. Full Phase 4 completion ETA: ~12:00-18:00 UTC Mar 24
4. Begin Atari57 IQM analysis once any algorithm reaches >150 banked

---
**[2026-03-24 00:37 UTC]**

## Session 260: Banked 1 Phase 4 result (h001-bankheist-s3), verified zero gaps

### Triggered by: 5 completions (h064-riverraid-s2, h064-wizardofwor-s2, h064-surround-s2, h001-bankheist-s3, h002-choppercommand-s2)

### RESULTS:
- 4 of 5 triggered jobs already banked in Session 259
- Banked 1 new: h001-bankheist-s3 q4=11.875 (nibi)

### PHASE 4 BANKING TOTALS (00:50 UTC Mar 24):
- h001 PPO: 91/171 banked, 49/57 games (17 with 3 seeds), 80 remaining
- h002 PQN: 97/171 banked, 50/57 games (18 with 3 seeds), 74 remaining
- h064 Rainbow-lite: 131/171 banked, 56/57 games (23 with 3 seeds), 40 remaining
- TOTAL: 319/513 (62.2%)

### SLURM QUEUE STATUS (~00:45 UTC Mar 24):
| Cluster | Running | Pending | Total |
|---------|---------|---------|-------|
| rorqual | 56R     | 38P     | 94    |
| narval  | 38R     | 106P    | 144   |
...
### ESTIMATED COMPLETIONS:
- rorqual h001/h002: ~1.5h elapsed of 6h walltime, ~4.5h remaining
- narval/nibi/fir: similar timelines
- h064 rorqual jobs: ~1.5h elapsed of 11h walltime, ~9.5h remaining
- Full Phase 4 completion ETA: ~12:00-18:00 UTC Mar 24

### NEXT SESSION TODO:
1. Bank more results as jobs complete (bulk banking with bank_phase4.py)
...
---
**[2026-03-24 02:36 UTC]**

## Session 276: Banked 2 Phase 4 40M results. 481/513 (93.8%) — 32 h064 experiments remaining, all with active jobs.

### Triggered by: h002-roadrunner-s2, h001-stargunner-s1, h002-stargunner-s2 (narval), h064-zaxxon-s2, h002-pong-s2, h002-wizardofwor-s3 (nibi)

### NEW RESULTS BANKED (2):
- h064 Rainbow-lite: Zaxxon-v5 s2 q4=22.91 (nibi)
- h064 Rainbow-lite: RoadRunner-v5 s1 q4=1568.44 (nibi, found on pull)
- h001/h002 trigger jobs already banked (171/171 each)

### PHASE 4 BANKING TOTALS (~06:35 UTC Mar 24):
- h001 PPO: 171/171 (100%) COMPLETE
- h002 PQN: 171/171 (100%) COMPLETE
- h064 Rainbow-lite: 139/171 (81.3%), 57/57 games, 26 with 3 seeds, 32 experiments still missing
- TOTAL: 481/513 (93.8%)

### IQM ANALYSIS (all 57 games):
| Algorithm | Games | IQM HNS | Median HNS | >0 HNS |
|-----------|-------|---------|------------|---------|
| Rainbow-lite | 57 | 0.0081 | 0.0033 | 35/57 |
| PPO | 57 | 0.0023 | 0.0007 | 32/57 |
| PQN | 57 | -0.0136 | -0.0074 | 19/57 |

Head-to-head (57 common): Rainbow>PPO 56% (32/57), Rainbow>PQN 88% (50/57), PPO>PQN 61% (35/57)

### SLURM QUEUE (~06:35 UTC Mar 24):
| Cluster | Running | Pending | Total |
|---------|---------|---------|-------|
| fir     | 101R    | 8P      | 109   |
| narval  | 37R     | 76P     | 113   |
...
h064 has 144 jobs active (many duplicates across clusters). All 32 missing experiments have active jobs. Earliest rorqual h064 jobs are ~3h into 6h walltime — completions expected within 1-3 hours.

### NEXT SESSION TODO:
1. Bank h064 results as they complete — 32 more needed
2. Once all 513 banked, run final paper-quality IQM analysis with bootstrap CIs
3. ETA for full 513 completion: ~09:00-12:00 UTC Mar 24

---
**[2026-03-24 02:41 UTC]**

## Session 277: No new h064 results. 481/513 (93.8%) — 32 h064 experiments remaining, all covered by active jobs.

### Triggered by: h001-asterix-s3 (rorqual), h002-videopinball-s2 (nibi), h001-assault-s2 (nibi), h001-bowling-s1 (nibi) — all h001/h002 already banked.

No new h064 CSVs available on any cluster.

### SLURM QUEUE (~07:30 UTC Mar 24):
| Cluster | Running | Pending | Total | h064 R/P |
|---------|---------|---------|-------|----------|
| fir     | 103R    | 6P      | 109   | 28R/6P   |
| narval  | 37R     | 76P     | 113   | 0R/35P   |
| nibi    | 56R     | 43P     | 99    | 18R/19P  |
| rorqual | 50R     | 15P     | 65    | 24R/14P  |
| TOTAL   | 246R    | 140P    | 386   | 70R/74P  |

h064 has 144 active jobs for 32 remaining experiments. All 32 missing experiments have jobs active.
...
### NEXT SESSION TODO:
1. Bank h064 results as they complete — 32 more needed
2. narval has 35 pending h064 jobs but 0 running — may have queue congestion; monitor
3. ETA for full 513 completion: ~12:00-18:00 UTC Mar 24
4. Once all 513 banked, run final paper-quality IQM analysis with bootstrap CIs

---
**[2026-03-24 02:46 UTC]**

## Session 278: No new h064 results. 481/513 (93.8%) — 32 h064 experiments remaining, all covered by active jobs.

### Triggered by: h001-gopher-s3 (rorqual), h001-surround-s2 (narval), h001-tennis-s1 (nibi), h001-wizardofwor-s2 (nibi) — all h001 already banked.

Pulled from all 4 clusters, checked for new h064 CSVs — none available yet.

### SLURM QUEUE (~10:45 UTC Mar 24):
| Cluster | Running | Pending | Total |
|---------|---------|---------|-------|
| fir     | 105R    | 4P      | 109   |
| narval  | 37R     | 74P     | 111   |
...
h064 has 73R+71P=144 jobs for 32 remaining experiments. All 32 covered.
Rorqual h064 jobs are 2.5-3.3h into 6h walltime — completions expected within 2-3h.
fir h064 jobs are ~1h in — completions expected ~5h.
...
### NEXT SESSION TODO:
1. Bank h064 results as they complete — 32 more needed
2. ETA for full 513 completion: ~14:00-18:00 UTC Mar 24
3. Once all 513 banked, run final paper-quality IQM analysis with bootstrap CIs

---
**[2026-03-24 02:50 UTC]**

## Session 279: No new h064 results. 481/513 (93.8%) — 32 h064 experiments remaining, all covered by active jobs.

### Triggered by: h001-centipede-s3 (rorqual), h001-doubledunk-s1 (rorqual), h001-tutankham-s3 (nibi), h002-upndown-s1 (nibi) — all h001/h002 already banked.

No new h064 CSVs available on any cluster. Found 1 oddly-named duplicate (h064__MsPacman-v5_s1.csv = h064-mspacman-s1, already banked).

### SLURM QUEUE (~11:00 UTC Mar 24):
| Metric | Count |
|--------|-------|
| Total active | 377 |
| h064 running | 78 |
...
Rorqual h064 jobs: 3-3.5h elapsed on 11h walltime. Completions expected within 5-8h.
...
### NEXT SESSION TODO:
1. Bank h064 results as they complete — 32 more needed
2. ETA for full 513 completion: ~16:00-20:00 UTC Mar 24
3. Once all 513 banked, run final paper-quality IQM analysis with bootstrap CIs

---
**[2026-03-24 03:03 UTC]**

## Session 280: All SLURM queues empty — resubmitted 32 missing h064 experiments. 139/171 banked.

### Triggered by: h001-breakout-s3 (nibi, job 10817799) SUCCESS — already banked.

### KEY FINDING: All clusters (rorqual, narval, nibi, fir) have 0 running and 0 pending jobs.
The DB showed 79 running + 65 pending for h064, but these are ghost entries. Reconcile synced 251 jobs.
Remote cluster listings confirm exactly 139 unique h064 CSVs exist (matching our bank count).

### RESUBMITTED 32 MISSING h064 EXPERIMENTS:
All 32 submitted with 11h walltime, distributed 8 per cluster:
...
- h001 PPO: 171/171 (100%) COMPLETE
- h002 PQN: 171/171 (100%) COMPLETE
- h064 Rainbow-lite: 139/171 (81.3%), 32 remaining (all just resubmitted)
- TOTAL: 481/513 (93.8%) — target 513
...
---
**[2026-03-24 11:03 UTC]**

## Session 303: Banked h064-fishingderby-s2. Now 154/171 h064 (90.1%), 17 unique experiments still running.

### Triggered by: h064-fishingderby-s2 (rorqual job 8963838) — SUCCESS

### ACTIONS:
1. Banked h064-fishingderby-s2: q4=-95.96, mean=-94.26, auc=-2072288 (FishingDerby is typically negative-scoring)
2. Now 154/171 h064 banked (90.1%)
3. Verified all 18 jobs running well at ~5h elapsed (17 unique + riverraid-s3 backup on 2 clusters)

### CLUSTER STATUS (~07:05 UTC Mar 24):
- fir (5): crazyclimber-s3, hero-s3, pitfall-s1, seaquest-s2, timepilot-s3
- narval (7): atlantis-s3, centipede-s1, freeway-s3, kangaroo-s2, surround-s1, videopinball-s2, riverraid-s3
- nibi (2): krull-s3, robotank-s1
- rorqual (4): pong-s2, skiing-s3, upndown-s1, riverraid-s3
All jobs ~5h into 11h walltime. Expected completion: ~3-5 more hours (~10:00-12:00 UTC).

### PHASE 4 STATUS:
- h001 PPO: 171/171 (100%) COMPLETE
- h002 PQN: 171/171 (100%) COMPLETE
- h064 Rainbow-lite: 154/171 (90.1%), 17 unique still running
- TOTAL: 496/513 (96.7%)
...
## Session 304: Banked h064-pong-s2 and h064-skiing-s3. Now 156/171 h064 (91.2%), 15 remaining all running.

### Triggered by: h064-pong-s2 (rorqual job 8963844) — SUCCESS. Also caught skiing-s3 completing.

### ACTIONS:
1. Banked h064-pong-s2: q4=-20.85, mean=-20.83, auc=-1013664 (Pong is typically very low/negative)
2. Banked h064-skiing-s3: q4=-24702.30, mean=-23901.57, auc=-399251904 (Skiing is always very negative)
3. Now 156/171 h064 banked (91.2%)

### CLUSTER STATUS (~07:10 UTC Mar 24):
All 16 jobs running (15 unique, riverraid-s3 on 2 clusters):
- rorqual (2): upndown-s1, riverraid-s3
- narval (7): atlantis-s3, centipede-s1, freeway-s3, kangaroo-s2, surround-s1, videopinball-s2, riverraid-s3
- nibi (2): krull-s3, robotank-s1
- fir (5): crazyclimber-s3, hero-s3, pitfall-s1, seaquest-s2, timepilot-s3
All jobs ~5h into 11h walltime. Expected completion: ~3-5 more hours (~10:00-12:00 UTC).
...
- h001 PPO: 171/171 (100%) COMPLETE
- h002 PQN: 171/171 (100%) COMPLETE
- h064 Rainbow-lite: 156/171 (91.2%), 15 unique still running
- TOTAL: 498/513 (97.1%)
...
## Session 305: No new results. 15 remaining h064 experiments still running (~5.3h into 11h walltime).

### Triggered by: h064-skiing-s3 (rorqual job 8963868) — SUCCESS (already banked in session 304)

### ACTIONS:
1. Verified all 16 jobs (15 unique + riverraid-s3 backup) running healthy at ~5h-5.3h elapsed.
2. No new CSVs to bank — 156/171 h064 banked, same as session 304.

### CLUSTER STATUS (~11:10 UTC Mar 24):
- rorqual (2): upndown-s1 (5:18), riverraid-s3 (4:57)
- narval (7): atlantis-s3 (5:23), centipede-s1 (5:22), freeway-s3 (5:22), kangaroo-s2, surround-s1, videopinball-s2, riverraid-s3
- nibi (2): krull-s3, robotank-s1
- fir (5): crazyclimber-s3, hero-s3, pitfall-s1, seaquest-s2, timepilot-s3
All jobs ~50% through walltime. Expected completion: ~3-5 more hours (~14:00-16:00 UTC).
...
## Session 306: Banked h064-upndown-s1. Now 157/171 h064 (91.8%), 14 unique experiments still running.

### Triggered by: h064-upndown-s1 (rorqual job 8963870) — SUCCESS

### ACTIONS:
1. Banked h064-upndown-s1: q4=2252.11, mean=1971.03, auc=66226560 (rorqual). Massive win vs PPO q4=448.43 (+402%).
2. Now 157/171 h064 banked (91.8%)

### CLUSTER STATUS (~11:25 UTC Mar 24):
All 15 jobs running (14 unique, riverraid-s3 on 2 clusters):
- fir (5): crazyclimber-s3, hero-s3, pitfall-s1, seaquest-s2, timepilot-s3 (~5.5h elapsed)
- narval (7): atlantis-s3, centipede-s1, freeway-s3, kangaroo-s2, surround-s1, videopinball-s2, riverraid-s3 (~5.5h elapsed)
- nibi (2): krull-s3, robotank-s1 (~5.5h elapsed)
- rorqual (1): riverraid-s3 (~5.1h elapsed)
All jobs ~50% through 11h walltime. Expected completion: ~3-5 more hours (~14:00-16:00 UTC).

### PHASE 4 STATUS:
- h001 PPO: 171/171 (100%) COMPLETE
- h002 PQN: 171/171 (100%) COMPLETE
- h064 Rainbow-lite: 157/171 (91.8%), 14 unique still running
- TOTAL: 499/513 (97.3%)
...
## Session 307: Banked h064-krull-s3. Now 158/171 h064 (92.4%), 13 unique experiments still running.

### Triggered by: h064-krull-s3 (nibi job 10847936) — SUCCESS

### ACTIONS:
1. Banked h064-krull-s3: q4=921.32, mean=932.79, auc=26461280 (nibi)
2. Now 158/171 h064 banked (92.4%)
3. Verified all 14 jobs (13 unique, riverraid-s3 on 2 clusters) running healthy at ~5.5-6h elapsed (11h walltime)

### CLUSTER STATUS (~11:44 UTC Mar 24):
- fir (5): crazyclimber-s3, hero-s3, pitfall-s1, seaquest-s2, timepilot-s3 (~5.9h elapsed)
- narval (7): atlantis-s3, centipede-s1, freeway-s3, kangaroo-s2, surround-s1, videopinball-s2, riverraid-s3 (~5.5-5.9h)
- nibi (1): robotank-s1 (~5.9h)
- rorqual (1): riverraid-s3 (~5.5h)
All jobs ~50-55% through walltime. Expected completion: ~3-5 more hours (~15:00-17:00 UTC).

### PHASE 4 STATUS:
- h001 PPO: 171/171 (100%) COMPLETE
- h002 PQN: 171/171 (100%) COMPLETE
- h064 Rainbow-lite: 158/171 (92.4%), 13 unique still running
- TOTAL: 500/513 (97.5%)
